...
/**
 * Security configuration class that requires authentication on all requests
 * except /, and uses the Spring Security authentication provider for Active
 * Directory. It also instantiates a custom user details mapper in order to
 * retrieve extra user attributes from Active Directory.
 */
@Configuration
